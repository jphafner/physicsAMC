    ...
    \begin{choices}
        ...
        \wrongchoice{
            \begin{tikzpicture}
                ...
                \addplot[line width=1pt]{sqrt(10)*sqrt(x)};
                \end{axis}
            \end{tikzpicture}
        }
        \wrongchoice{
    ...
    \begin{choices}
        ...
        \wrongchoice{
            \begin{tikzpicture}
                ...
                \addplot[line width=1pt]{0.1*x*x};
                \end{axis}
            \end{tikzpicture}
        }
    \end{choices}
...
\begin{question}{June1981-Q37}
    How much work is done in moving 6 electrons through a potential difference of \SI{2.0}{\volts}?
    \begin{multicols}{2}
    \begin{choices}
