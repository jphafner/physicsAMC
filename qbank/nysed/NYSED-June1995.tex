    ...
    \begin{choices}
        ...
        \wrongchoice{
            \begin{tikzpicture}
                ...
                \addplot[line width=1pt,mark=\empty] plot coordinates { 2 + 0.08*x*x };
                \end{axis}
            \end{tikzpicture}
        }
        \wrongchoice{
            \begin{tikzpicture}
                ...
                \addplot[line width=1pt,mark=\empty] plot coordinates { 0.1*x*x };
                \end{axis}
            \end{tikzpicture}
        }
        \wrongchoice{
            \begin{tikzpicture}
                ...
                \addplot[line width=1pt,mark=\empty] plot coordinates {x};
                \end{axis}
            \end{tikzpicture}
        }
        \wrongchoice{
            \begin{tikzpicture}
                ...
                \addplot[line width=1pt,mark=\empty] plot coordinates {10-x};
                \end{axis}
            \end{tikzpicture}
        }
    \end{choices}
...
\begin{question}{June1984-Q23}
    ...
    \begin{choices}
        \wrongchoice{the same ampltiude and the same frequency}
        \wrongchoice{the same ampltiude and different frequencies}
        \wrongchoice{different ampltiudes and the same frequency}
        \wrongchoice{different ampltiudes and different frequencies}
    \end{choices}
\end{question}
}
...
\begin{question}{June1984-Q32}
    ...
    \begin{multicols}{2}
    \begin{choices}
        \wrongchoice{gaines protons}
        \wrongchoice{gaines electrons}
        \wrongchoice{loses protons}
        \wrongchoice{loses electrons}
    \end{choices}
    \end{multicols}
\end{question}
}
...
\begin{question}{June1984-Q33}
    A negatively charged rod is held near the knob of an uncharge electroscope.
