...
\begin{question}{June2016-Q14}
	Two objects, A and B, are held one meter above
the horizontal ground. The mass of B is twice as
great as the mass of A. If PE is the gravitational
potential energy of A relative to the ground, then
the gravitational potential energy of B relative to
the ground is
PE
    \begin{multicols}{2}
    \begin{choices}
