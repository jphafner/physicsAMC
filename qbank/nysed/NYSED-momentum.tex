...
\begin{question}{June2016-Q08}
    ...
    The magnitude of the momentum of the blue cart before the collision is \SI{2.0}{\kilo\gram\meter\per\second},
        and the magnitude of the momentum of the red cart before the collision is \SI{3.0}{\kilo\gram\meter\per\second}.
    The magnitude of the total momentum of the two carts after the collision is:
    \begin{multicols}{2}
    \begin{choices}
      \correctchoice{\SI{1.0}{\kilo\gram\meter\per\second}}
...
\begin{question}{June2016-Q43}
    ...
    \begin{multicols}{2}
    \begin{choices}
      \correctchoice{\SI{18.0}{\meter\per\second} east}
        \wrongchoice{\SI{20.5}{\meter\per\second} west}
        \wrongchoice{\SI{19.5}{\meter\per\second} east}
        \wrongchoice{\SI{22.0}{\meter\per\second} west}
    \end{choices}
    \end{multicols}
\end{question}
}
...
\begin{question}{June1985-Q10}
    ...
    \begin{tikzpicture}
        ...
        %% left
        \node[anchor=south,draw,minimum width=1.5cm,minimum height=1cm] (L) at (-2,0.2) {\SI{2}{\kilo\gram}};
        \draw[fill=white] (L.south west) ++(+0.3,0) circle (0.2);
        \draw[fill=black] (L.south west) ++(+0.3,0) circle (1.5pt);
        \draw[fill=white] (L.south east) ++(-0.3,0) circle (0.2);
        \draw[fill=black] (L.south east) ++(-0.3,0) circle (1.5pt);
        %% right
        \node[anchor=south,draw,minimum width=2cm,minimum height=1cm] (R) at (+2,0.2) {\SI{3}{\kilo\gram}};
        \draw[fill=white] (R.south west) ++(+0.3,0) circle (0.2);
        \draw[fill=black] (R.south west) ++(+0.3,0) circle (1.5pt);
        \draw[fill=white] (R.south east) ++(-0.3,0) circle (0.2);
        \draw[fill=black] (R.south east) ++(-0.3,0) circle (1.5pt);
        %% spring
