...
\publishers{
    ...
    You may \emph{only} use a black ink pen on the response sheet.
    %either an HB or \textnumero{}2 graphite pencil,
    ...
    Anything that is not strictly forbidden, is allowed.
    \emph{Good Luck!}
}
